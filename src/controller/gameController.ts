...
export class GameController {
  ...
  constructor(public readonly params: string[]) {
    ...
    this.gameRules = new GameRules(this.gameModel.getNodes(), this.gameModel.getAdjacencyMatrix());
  }
  ...
  public playGame(): void {
    while (true) {
      ...
      this.gameView.printLog(this.gameRules.getResult(userMove, computerMove));
  ...
  private getUserMove(): string {
    ...
    if (userMove === '?') {
      this.gameView.showHelp(this.gameModel.getNodes(), this.gameModel.getAdjacencyMatrix());
